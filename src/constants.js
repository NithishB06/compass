...
export const constants = {
  ...
  SHOW_HOME_BUTTON_ELEMENT: `document.querySelector("body > settings-ui").shadowRoot.querySelector("#main").shadowRoot.querySelector("settings-basic-page").shadowRoot.querySelector("#basicPage > settings-section:nth-child(17) > settings-appearance-page").shadowRoot.querySelector("#pages > div > settings-toggle-button:nth-child(4)").shadowRoot.querySelector("#sub-label-text")`,
  SHOW_HOME_BUTTON_TOGGLE_BUTTON: `document.querySelector("body > settings-ui").shadowRoot.querySelector("#main").shadowRoot.querySelector("settings-basic-page").shadowRoot.querySelector("#basicPage > settings-section:nth-child(17) > settings-appearance-page").shadowRoot.querySelector("#pages > div > settings-toggle-button:nth-child(4)").shadowRoot.querySelector("#control")`,
  ENTER_HOME_PAGE_WEB_ADDRESS_FIELD: `document.querySelector("body > settings-ui").shadowRoot.querySelector("#main").shadowRoot.querySelector("settings-basic-page").shadowRoot.querySelector("#basicPage > settings-section:nth-child(17) > settings-appearance-page").shadowRoot.querySelector("#customHomePage").shadowRoot.querySelector("#input").shadowRoot.querySelector("#input")`,

  OPEN_SPECIFIC_PAGE_RADIO_BUTTON: `document.querySelector("body > settings-ui").shadowRoot.querySelector("#main").shadowRoot.querySelector("settings-basic-page").shadowRoot.querySelector("#basicPage > settings-section:nth-child(22) > settings-on-startup-page").shadowRoot.querySelector("#onStartupRadioGroup > controlled-radio-button:nth-child(4)").shadowRoot.querySelector("#button")`,
  ADD_A_NEW_PAGE_LINK: `document.querySelector("body > settings-ui").shadowRoot.querySelector("#main").shadowRoot.querySelector("settings-basic-page").shadowRoot.querySelector("#basicPage > settings-section:nth-child(22) > settings-on-startup-page").shadowRoot.querySelector("settings-startup-urls-page").shadowRoot.querySelector("#addPage > a")`,
  ADD_A_NEW_PAGE_POPUP_INPUT_BOX: `document.querySelector("body > settings-ui").shadowRoot.querySelector("#main").shadowRoot.querySelector("settings-basic-page").shadowRoot.querySelector("#basicPage > settings-section:nth-child(22) > settings-on-startup-page").shadowRoot.querySelector("settings-startup-urls-page").shadowRoot.querySelector("settings-startup-url-dialog").shadowRoot.querySelector("#url").shadowRoot.querySelector("#input")`,
